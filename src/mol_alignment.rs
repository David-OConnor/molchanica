...
impl AlignmentResult {
    pub fn new(mol0: &MoleculeCommon, mol1: &MoleculeCommon) -> Self {
...
///
pub fn align(mol_0: &MoleculeSmall, mol_1: &MoleculeSmall) -> Vec<AlignmentResult> {
...
// pub struct MolAlign {
//     cfg: MolAlignConfig,
//     gen_a: Option<Conformer>,
//     gen_b: Option<Conformer>,
//
...
//         &self,
//         mol: &MoleculeCommon,
//         gen_: Option<Conformer>,
//         rng: &mut SmallRng,
//     ) -> Vec<Conformer> {
//         if let Some(g) = gen_ {
//             // let mut v = g.generate(mol, 50, rng);
//             let mut v = Vec::new() ; // todo!!
//
//             if v.is_empty() {
//                 v.push(Conformer {
...
// /* ------------------------- Pose moves (rigid) ------------------------- */
//
// fn random_transform(rng: &mut SmallRng) -> Transform {
