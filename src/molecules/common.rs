...
pub struct MoleculeCommon {
    ...
    // /// Is associated with this range of atom indices in a MD snapshot; either loaded from file,
    // /// or generated by this program.
    // /// todo: Not yet implemented. Impl A/R
    // pub md_snapshot_range: Option<(usize, usize)>,
}
